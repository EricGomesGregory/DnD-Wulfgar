# Arendal Quests
___
Arendal is a large walled town located in a valley in between two small mountains. The valley is part of a network of roads that connects Hoffnar, Jomfort, Eldunhall and Arrynhall.

The town is a hub for dwarven mercenaries to stage incursions into the kings plains. In recent years the towns activity has reduced since a crew of privateers from Vitinnhall have crossed the boiling sea and returned with a endless flame.
___
When the party arrives, the town is in a state of irrelevance...
...
## Town of Arendal
The town of Arendal is a large walled population center that sits between two mountains, one smaller than the other. Atop the smaller mountain, facing the Kings Plains, sits the fortress of Orser while atop the larger mountain sits the fortress of Kvarven.

The town on the valley...

### Orser Fortress
The Orser fortress is a five point star-fort that sits atop the smaller mountain but extends to the underground and connects back to the valley.


### Walled Valley
The majority of the population of Arendal lives on the walled section of the valley. There the party can find the following notable locations.

#### Dancing Gnome Inn
The Dancing Gnome inn is a large two story-tall stone brick building near the Hoffnar gate with a large wooden plack depicting a dancing gnome.

Within it the party can find the following characters...


#### Praying Fox
The Praying Fox is a large wooden building on the 


### Kvarven Fortress
The Kvarven fortress is a large square stone brick carved out of the side of the larger mountain...
