...
### Master Ranger
At 20th level, fluff. Your mark's duration increases to 24 hours, making a short or long rest doesn't removes the mark, you can use a bonus action to move the mark to another creature within range that you can see (or end the mark), and attacks made against marked targets take extra damage equal to your Wisdom modifier.
